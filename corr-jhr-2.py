...
### Encore bonjour Catherine ###
### Comme toujours, mes notes et corrections sont précédées de trois dièses ###

### Ce script ne comporte aucun commentaire. Je dois donc deviner ce qu'il fait...
### Je devine donc que tu as tenté une autre stratégie pour recueillir une liste des recours collectifs
